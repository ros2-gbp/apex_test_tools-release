...
%global pkg_name test_apex_test_tools
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-test-apex-test-tools
Version:        0.0.2
Release:        10%{?dist}
...
%changelog
* Wed Apr 29 2026 Apex.AI, Inc. <opensource@apex.ai> - 0.0.2-10
- Autogenerated by Bloom

* Tue Apr 28 2026 Apex.AI, Inc. <opensource@apex.ai> - 0.0.2-9
- Autogenerated by Bloom

* Tue Apr 21 2026 Apex.AI, Inc. <opensource@apex.ai> - 0.0.2-8
- Autogenerated by Bloom
